...
describe 'Visitor' do
  it 'can visit the root page, enter a word, and receive examples on how to use that word in a certain region and not other regions' do
    ...
    expect(page).to_not have_content('ry to develop deep concentration through the awareness of the breath which is called the mindfulness of the breath or you can say mindfulness of the body.')
  end
end
